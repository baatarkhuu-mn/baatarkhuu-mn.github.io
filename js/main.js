...
(function () {
  ...
  const I18n = {
    ...
    dict: {
      ...
      "Санал илгээх процесс": "How feedback is processed",
      "Шийдвэрлэлтийн тоон мэдээ": "Resolution statistics",
      ...
      "Хаяг": "Address",
      "Ажлын цаг": "Office hours",
      "Даваа–Баасан, 09:00–18:00 · Бямба, Ням: Амарна": "Mon–Fri, 09:00–18:00 · Sat, Sun: Closed",
      "Дагах": "Follow",
      "АН — Чингэлтэй дүүрэг": "DP — Chingeltei district",
      "Асуудлын төрлөө": "Choose the issue",
      "сонгоно": "type",
      "Байршлаа": "Set your location",
      "Асуудлаа": "Describe the issue",
      "дэлгэрэнгүй": "in detail",
      "Зураг, видео": "Photos and videos",
      "заавал хавсаргана": "must be attached",
      "дарна": "press it",
      "ИРГЭДЭЭ СОНСОХ": "LISTENING TO CITIZENS",
      "НЭГДСЭН СИСТЕМ": "UNIFIED SYSTEM",
      "САНАЛ, ГОМДОЛ, ӨРГӨДӨЛ ГАРГАХ": "SUBMIT FEEDBACK, COMPLAINTS, PETITIONS",
      "Асуудлын төрөл": "Issue type",
      "Авто зам, тээвэр": "Roads and transport",
      "Сүхбаатар дүүрэг, 1-р хороо": "Sukhbaatar district, 1st khoroo",
      "Асуудлын дэлгэрэнгүй": "Issue details",
      "Энхтайваны өргөн чөлөөний авто замын тэмдэг, тэмдэглэгээ арррд.": "Road signs and markings on Peace Avenue need repair.",
      "Зураг, видео хавсаргах (заавал)": "Attach photos or video (required)",
      "Асуудлыг тодорхой харуулсан зураг эсвэл видео оруулна уу.": "Please add a photo or video that clearly shows the issue.",
      "Зураг нэмэх": "Add photo",
      "Видео нэмэх": "Add video",
      "Зөвхөн JPG, PNG, MP4 форматаар, 50MB хүртэл": "JPG, PNG, MP4 only, up to 50MB",
      "Маягтаа бөглөж,": "Fill in the form, add your",
      "холбоо барих мэдээллээ": "contact details",
      "оруулаад «Илгээх» дарна.": "and press «Submit».",
      "Эцэст нь": "Finally, add your",
      "нэр, утас, имэйлээ": "name, phone and email",
      "Таны мэдээллийг зөвхөн хариу өгөх зорилгоор ашиглана. Хувийн мэдээлэл (нэр, утас, имэйл) нийтэд харагдахгүй.": "Your details are used only to respond to you. Personal information (name, phone, email) is never shown publicly.",
      "Санал хүсэлтээ илгээнэ үү": "Submit your feedback",
      "Хүсэлтийн байршил": "Request location",
      "Холбоо барих мэдээлэл": "Contact details",
      "Нэр, утас, имэйл": "Name, phone, email",
      "— зөвхөн хүсэлт, зураг, байршил. Бусад иргэд дэмжиж, коммент бичиж болно.": "— only the request, photos and location are shown. Other citizens can support and comment.",
      "ИРГЭДИЙН САНАЛ ХҮСЭЛТИЙГ ШИЙДВЭРЛЭХ СИСТЕМ": "CITIZEN FEEDBACK RESOLUTION SYSTEM",
      "Та өөрийн санал, хүсэлтийн явцаа шалгана уу": "Track the progress of your request",
      "Сүүлийн үеийн видео мэдээ": "Latest video news",
      "Дугаараа оруулаад": "Enter your tracking number, press",
      "«Шалгах»": "«Check»",
      "дарвал саналын явц, шийдвэрлэлтийн үе шат энд харагдана.": "— the progress and resolution stages will appear here.",
      "Цэндийн Баатархүү — Монгол Улсын Их Хурлын гишүүн": "Tsendiin Baatarkhuu — Member of the State Great Khural of Mongolia",
      "Монгол Улс 14201 Улаанбаатар хот, Сүхбаатар дүүрэг, Жанжин Д.Сүхбаатарын талбай 1, Төрийн ордон.": "Government Palace, 1 Chinggis Square, Sukhbaatar District, Ulaanbaatar 14201, Mongolia",
  ...
  const PublicFeed = {
    ...
    statusChip(r) {
      // Админы 7 төлөвийг нийтэд 4 бүлгээр харуулна (in_progress = Явцад, cancelled = Цуцлагдсан)
      if (r.status === "cancelled") return '<span class="fc2-status fc2-st-cancel"><i class="st-dot"></i>Цуцлагдсан</span>';
      const done = r.status === "done" || r.status === "resolved" || !!r.response;
      const routed = r.status === "routed" || r.status === "processing" || r.status === "responded" || r.status === "in_progress" || !!r.org;
    ...
    renderTopFeed() {
      ...
      // Эхний 4-ийг л харуулж, бусдыг товчоор дэлгэнэ (нүүрэнд бүгдийг ил)
    ...
    async init() {
      ...
      try {
        ...
        const loadFeat = (i) => {
          ...
          // Тоглож буй видеог жагсаалтад давхардуулж харуулахгүй
          items.forEach((b, j) => { b.classList.toggle("on", j === i); b.style.display = j === i ? "none" : ""; });
          VideoCMS.parseFB();
        };
