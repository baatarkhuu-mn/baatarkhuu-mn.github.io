...
-- (2026-07-10 нэмэлт) Картын нүүр зураг — өмнө нь ажиллуулсан бол зөвхөн энэ мөрийг дахин Run хийхэд хангалттай
alter table public.polls add column if not exists image text;
